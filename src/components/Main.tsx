			...
			<div className="max-w-4xl mx-auto p-4">
				...
				<div className="space-y-8 text-gray-700">
					<p className="leading-relaxed">
						O programa Agente Escola do Futuro é uma iniciativa do Governo Federal que marca a ampliação da
					...
					<p className="leading-relaxed">
						Os salários variam entre R$ <span className="text-[#1351B4]">3.584,22</span> e R$
						<span className="text-[#1351B4]">4.956,13</span>, dependendo da região e da modalidade de
						atuação.
					</p>
						...
						<div className="p-8 bg-gray-50">
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
								...
								<div className="bg-white p-5 rounded border-l-4 border-[#1351B4] shadow-sm">
									...
									<div className="text-2xl font-bold text-[#1351B4]">R$ 3.584,22 a R$ 4.956,13</div>
							...
							<div className="mt-8 bg-blue-50 p-3 border border-blue-100 rounded text-center">
								<span className="text-sm font-bold text-[#1351B4]">Última atualização: maio/2025</span>
							</div>
						</div>
					</div>
						...
						<div className="p-6">
							<ul className="space-y-4 list-disc pl-4">
								...
								<li>
									...
									diplomadas(os) até novembro de <span className="text-[#1351B4]">2025</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="mt-12 border border-gray-200 overflow-hidden">
						...
						<div className="p-6 text-center">
							...
							<p className="text-gray-600">Prazo final: 30/06/2025</p>
						</div>
					</div>
