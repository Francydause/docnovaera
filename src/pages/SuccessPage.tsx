			...
			<div className="max-w-3xl mx-auto">
				<div className="bg-white rounded-lg p-8">
					...
					<div className="space-y-6 text-lg">
						...
						<p>
							Recebemos sua inscrição para a vaga no programa Agente Escola do Futuro destinado ao
						...
						<div className="mt-12 flex justify-center">
							<button
								onClick={() => navigate("/")}
								className="bg-[#1351B4] text-white px-12 py-4 rounded-full text-lg font-semibold hover:bg-[#1351B4]/90 transition-colors"
							>
								FINALIZAR
							</button>
						</div>
